...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\aservice\x18\x03 \x01(\v2\x13.kratos.api.ServiceR\aservice\"[\n" +
	"\aService\x122\n" +
	"\x06consul\x18\x01 \x01(\v2\x1a.kratos.api.Service.ConsulR\x06consul\x1a\x1c\n" +
	"\x06Consul\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
