...
const file_api_valuation_valuation_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/valuation/valuation.proto\x12\rapi.valuation\"S\n" +
	...
	"\tValuation\x12`\n" +
	"\x10GetEstimatePrice\x12&.api.valuation.GetEstimatePriceRequest\x1a$.api.valuation.GetEstimatePriceReplyB#Z!valuation/api/valuation;valuationb\x06proto3"
